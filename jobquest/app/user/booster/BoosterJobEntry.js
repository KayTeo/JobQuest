                                ...
                                <div className="flex w-full flex-col items-center gap-5">
                                    <div className="flex w-full flex-col gap-2">
                                        ...
                                        <section className="flex flex-col">
                                            {formattedBoostData.coverLetter.map(
                                                (e) => (
                                                    <div key={e}>{e}</div>
                                                )
                                            )}
                                    ...
                                    <div className="flex w-full flex-col gap-2">
                                        ...
                                        <section className="flex flex-col">
                                            {formattedBoostData.projectData.map(
                                                (e) => (
                                                    <div key={e}>{e}</div>
                                                )
                                            )}
                                    ...
                                    <div className="flex w-full flex-col gap-2">
                                        ...
                                        <section className="flex flex-col">
                                            {formattedBoostData.workData.map(
                                                (e) => (
                                                    <div key={e}>{e}</div>
                                                )
                                            )}
                                    ...
                                    <div className="flex w-full flex-col gap-2">
                                        ...
                                        <section className="flex flex-col">
                                            {formattedBoostData.ccaData.map(
                                                (e) => (
                                                    <div key={e}>{e}</div>
                                                )
                                            )}
                                    ...
                                    <div className="flex w-full flex-col gap-2">
                                        ...
                                        <section className="flex flex-col">
                                            {formattedBoostData.skillsData.map(
                                                (e) => (
                                                    <div key={e}>{e}</div>
                                                )
                                            )}
